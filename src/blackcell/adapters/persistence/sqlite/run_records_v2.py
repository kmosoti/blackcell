...
from ._run_records_v2_artifacts import (
    _artifact_digest,
    _artifact_link,
    _decode_owner,
    _link,
    _media_type,
    _result_matches_preparation,
    _run_link,
    _snapshot_digest,
    _state_payload,
    _strings,
    _text,
    _usage_payload,
    _verify_owner_event_fields,
    _verify_owner_identity,
)
from ._run_records_v2_protocol import (
    _decision_affordance,
    _event,
    _execution_binding_id,
    _execution_matches_run,
    _material_outcome,
    _NoCheckpoints,
    _proposal_matches_response,
    _required_occurrence,
    _trace_entries,
    _usage_within_budget,
)
...
class KernelFeedbackRunRecorder:
    ...
    def _verify_cross_bindings(
        ...
        *,
        ...
        recomputed_authorization = authorize_action(
            AuthorizeAction(
                proposal,
