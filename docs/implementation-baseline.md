...
adapter-discovery service and predecessor Repository Operator/Daily Operator baseline writers are also
...
as feedback histories; their writer is not public or composed. The exact before/after evidence is recorded in
