...
Status: product accepted — public facade delegates to canonical Daily Operator feedback; predecessor retired
...
The public `RepositoryOperator` composes `DailyOperatorWorkflow`, the model gateway, typed
...
- state, context, and replay inspection use the canonical runtime-foundation contracts;
