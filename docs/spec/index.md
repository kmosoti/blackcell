...
5. `BCP-0032`: Repository Operator acceptance surface over canonical Daily Operator feedback.
6. `BCP-0033`: deterministic OperatorBench fixture pilot.

## Active runtime-foundation program
...
7. `BCP-0034`: continuous migration from the accepted legacy product into one canonical
   ...
   deployment and matched experiments.
...
are runtime-foundation program work after that join, not additional Phase 1 requirements.
