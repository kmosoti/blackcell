...
| --- | --- | --- |
| WP00 | Baseline, branch, migration ledger, preservation boundaries | complete on merge of this change |
| WP01 | Architecture decision record and package contracts | pending |
