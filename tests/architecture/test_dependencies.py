...
_VERSION_BOUNDARY_MODULES = frozenset(
    {
        ...
        "blackcell.interfaces.presentation.a2ui",
        "blackcell.interfaces.presentation.fields",
        "blackcell.interfaces.presentation.models",
        "blackcell.interfaces.presentation.projector",
        "blackcell.interfaces.presentation.qa",
